...
class StaffViewController: UIViewController,UITableViewDataSource,UITableViewDelegate, UISearchBarDelegate{
    ...
    @IBOutlet weak var allStaffTable: UITableView!
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toStaffDetails"{
            let secondViewController = segue.destination as! StaffDetailViewController
